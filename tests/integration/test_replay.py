...
def replay_file(tmp_path: Path) -> tuple[Path, list[dict[str, object]]]:
    events: list[dict[str, object]] = [
        ...
        {"timestamp": 2_000_000_000, "pid": 5678, "process": "curl", "payload": "connect 1.2.3.4:80"},
    ]
...
def test_replay_source_feeds_record_sink(replay_file: tuple[Path, list[dict[str, object]]]) -> None:
